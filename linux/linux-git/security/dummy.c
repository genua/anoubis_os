...
static int dummy_socket_accepted (struct socket *sock, struct socket *newsock)
{
	return 0;
}
...
static int dummy_socket_skb_recv_datagram (struct sock *sk, struct sk_buff *skb)
{
	return 0;
}
...
void security_fixup_ops (struct security_operations *ops)
{
	...
	set_to_dummy_if_null(ops, socket_accepted);
	...
	set_to_dummy_if_null(ops, socket_skb_recv_datagram);
