...
int	sys_extattr_set_link(struct proc *, void *, register_t *);
int	sys_extattr_get_link(struct proc *, void *, register_t *);
int	sys_extattr_delete_link(struct proc *, void *, register_t *);
int	sys_extattr_list_fd(struct proc *, void *, register_t *);
int	sys_extattr_list_file(struct proc *, void *, register_t *);
int	sys_extattr_list_link(struct proc *, void *, register_t *);
...
int	sys___acl_set_fd(struct proc *, void *, register_t *);
int	sys___acl_delete_file(struct proc *, void *, register_t *);
int	sys___acl_delete_fd(struct proc *, void *, register_t *);
int	sys___acl_aclcheck_file(struct proc *, void *, register_t *);
int	sys___acl_aclcheck_fd(struct proc *, void *, register_t *);
int	sys___acl_get_link(struct proc *, void *, register_t *);
int	sys___acl_set_link(struct proc *, void *, register_t *);
int	sys___acl_delete_link(struct proc *, void *, register_t *);
