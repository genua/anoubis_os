...
struct sysent sysent[] = {
	...
	{ 5, s(struct sys_extattr_get_fd_args), 0,
	    sys_extattr_get_fd },		/* 307 = extattr_get_fd */
	{ 3, s(struct sys_extattr_delete_fd_args), 0,
	    sys_extattr_delete_fd },		/* 308 = extattr_delete_fd */
	{ 5, s(struct sys_extattr_set_link_args), 0,
	    sys_extattr_set_link },		/* 309 = extattr_set_link */
	{ 5, s(struct sys_extattr_get_link_args), 0,
	    sys_extattr_get_link },		/* 310 = extattr_get_link */
	{ 3, s(struct sys_extattr_delete_link_args), 0,
	    sys_extattr_delete_link },		/* 311 = extattr_delete_link */
	{ 4, s(struct sys_extattr_list_fd_args), 0,
	    sys_extattr_list_fd },		/* 312 = extattr_list_fd */
	{ 4, s(struct sys_extattr_list_file_args), 0,
	    sys_extattr_list_file },		/* 313 = extattr_list_file */
	{ 4, s(struct sys_extattr_list_link_args), 0,
	    sys_extattr_list_link },		/* 314 = extattr_list_link */
	{ 5, s(struct sys_extattrctl_args), 0,
	    sys_extattrctl },			/* 315 = extattrctl */
	{ 5, s(struct sys_extattr_set_file_args), 0,
	    sys_extattr_set_file },		/* 316 = extattr_set_file */
	{ 5, s(struct sys_extattr_get_file_args), 0,
	    sys_extattr_get_file },		/* 317 = extattr_get_file */
	{ 5, s(struct sys_extattr_delete_file_args), 0,
	    sys_extattr_delete_file },		/* 318 = extattr_delete_file */
#else
	{ 0, 0, 0,
	...
	{ 3, s(struct sys___acl_set_file_args), 0,
	    sys___acl_set_file },		/* 320 = __acl_set_file */
	{ 3, s(struct sys___acl_get_fd_args), 0,
	    sys___acl_get_fd },			/* 321 = __acl_get_fd */
	{ 3, s(struct sys___acl_set_fd_args), 0,
	    sys___acl_set_fd },			/* 322 = __acl_set_fd */
	{ 2, s(struct sys___acl_delete_file_args), 0,
	    sys___acl_delete_file },		/* 323 = __acl_delete_file */
	{ 2, s(struct sys___acl_delete_fd_args), 0,
	    sys___acl_delete_fd },		/* 324 = __acl_delete_fd */
	{ 3, s(struct sys___acl_aclcheck_file_args), 0,
	    sys___acl_aclcheck_file },		/* 325 = __acl_aclcheck_file */
	{ 3, s(struct sys___acl_aclcheck_fd_args), 0,
	    sys___acl_aclcheck_fd },		/* 326 = __acl_aclcheck_fd */
	{ 3, s(struct sys___acl_get_link_args), 0,
	    sys___acl_get_link },		/* 327 = __acl_get_link */
	{ 3, s(struct sys___acl_set_link_args), 0,
	    sys___acl_set_link },		/* 328 = __acl_set_link */
	{ 2, s(struct sys___acl_delete_link_args), 0,
	    sys___acl_delete_link },		/* 329 = __acl_delete_link */
	{ 3, s(struct sys___acl_aclcheck_link_args), 0,
	    sys___acl_aclcheck_link },		/* 330 = __acl_aclcheck_link */
#else
	{ 0, 0, 0,
