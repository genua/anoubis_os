...
char *syscallnames[] = {
	...
	"extattr_set_link",			/* 309 = extattr_set_link */
	"extattr_get_link",			/* 310 = extattr_get_link */
	"extattr_delete_link",			/* 311 = extattr_delete_link */
	"extattr_list_fd",			/* 312 = extattr_list_fd */
	"extattr_list_file",			/* 313 = extattr_list_file */
	"extattr_list_link",			/* 314 = extattr_list_link */
	"extattrctl",			/* 315 = extattrctl */
	"extattr_set_file",			/* 316 = extattr_set_file */
	"extattr_get_file",			/* 317 = extattr_get_file */
	"extattr_delete_file",			/* 318 = extattr_delete_file */
#else
	...
	"__acl_set_fd",			/* 322 = __acl_set_fd */
	"__acl_delete_file",			/* 323 = __acl_delete_file */
	"__acl_delete_fd",			/* 324 = __acl_delete_fd */
	"__acl_aclcheck_file",			/* 325 = __acl_aclcheck_file */
	"__acl_aclcheck_fd",			/* 326 = __acl_aclcheck_fd */
	"__acl_get_link",			/* 327 = __acl_get_link */
	"__acl_set_link",			/* 328 = __acl_set_link */
	"__acl_delete_link",			/* 329 = __acl_delete_link */
	"__acl_aclcheck_link",			/* 330 = __acl_aclcheck_link */
#else
